...
if (isset($_POST['btn']))
{
    ...
    $queryunlink="SELECT * FROM bookcata WHERE ccid='$getid'";
    ...
    unlink("../images/upcoming-release/thumb/$auth");
    ...
    $query="UPDATE bookcata SET cata_id='$id',file='$filename',pic='$filename1',bname='$name',btext='$body',pbookname='$pname',pbooktext='$pbody',p_type_id='$author_type',auth_id='$author_name',book_price='$book_price' WHERE ccid='$getid'";
    $db->update($query);
}


$select_query="select * from bookcata WHERE ccid='$getid'";

$result=$db->select($select_query);

$rowfor=$result->fetch_array();
        ...
        <div class="page-content">
            ...
            <div class="page-head">
                ...
                <div class="page-title">
                    <h1>update file
                        <small>Be Carefully to update vaild file here!</small>
                    </h1>
                </div>
                <!-- END PAGE TITLE -->
                <!-- BEGIN PAGE TOOLBAR -->
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span class="active">update file</span>
                </li>
            </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="edit_cate.php?id=<?php echo $getid=$rowfor['ccid']; ?>" enctype="multipart/form-data" id="submit_form" method="POST">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control " required style="text-align: right" name="pashto_name"  value="<?php echo  $rowfor['pbookname']; ?>" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea rows="15" required class="ckeditor form-control" style="text-align: right" name="body2"><?php echo  $rowfor['pbooktext']; ?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control " required name="english_name" value="<?php echo  $rowfor['bname']; ?>" />
                                                        <div id="form_gender_error"> </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea rows="15" required class="ckeditor form-control" name="body1"><?php echo  $rowfor['btext']; ?></textarea>
                                                        <span class="help-block"> Provide information about book </span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" value="<?php echo  $rowfor['book_price']; ?>" name="price" class="form-control">
