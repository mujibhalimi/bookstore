                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="insert_ads.php" class="btn green"> Add New
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <tr>
                                    ...
                                    <td class="center"> <img class="thumbnail" style="height: 100px; width: 100px;" src="../images/add-banners/add-books/<?php echo $row['photo'] ; ?>"></td>
                                    <td>
                                        <a class="btn btn-primary" href="edit_ads.php?id=<?php echo $row['ads_id']; ?>"> Edit </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger"  href="del_ads.php?id=<?php echo $row['ads_id']; ?>"> Delete </a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                                </tbody>
