...
if (isset($_POST['btn'])) {
    ...
    $query = "UPDATE b_news SET heading='$head1',body='$body1',footer='$footer',pic='$filename',pashto_head='$head2',pashto_body='$body2',pashto_footer='$pfooter' WHERE id='$id'";
    $run = $db->update($query);
}

$select="SELECT * FROM b_news WHERE id='$id'";
                            ...
                            <div class="portlet light bg-inverse">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red-sunglo bold uppercase">edit news</span>
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="edit_news.php?id=<?php echo $id=$row['id']; ?>" method="post" enctype="multipart/form-data" class="horizontal-form">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="head2" value="<?php echo $row['pashto_head']; ?>" name="head2" class="form-control" placeholder="عنوان">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label">pashto footer</label>

                                                            <input type="text" value="<?php echo $row['pashto_footer']; ?>" name="pfooter" class="form-control" id="">

                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="control-label">english footer</label>

                                                                <input type="text" name="footer" value="<?php echo $row['footer']; ?>" class="form-control" id="">
