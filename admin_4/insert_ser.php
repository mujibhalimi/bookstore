...
if (isset($_POST['btn'])) {
    ...
    $query = "INSERT INTO `services` (`heading`, `body`,`pashto_head`,`pashto_body`) VALUES ( '$head1'
     ,'$body1','$head2','$body')";
    $run = $db->insert($query);
}
                            ...
                            <div class="portlet light bg-inverse">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red-sunglo bold uppercase">Insert services</span>
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="insert_ser.php" method="post" enctype="multipart/form-data" class="horizontal-form">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
