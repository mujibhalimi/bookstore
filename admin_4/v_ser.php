                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="insert_ser.php" class="btn green"> Add New
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="edit_ser.php?id=<?php echo $row['id']; ?>"> Edit </a>
                                    </td>
                                    <td>
                                        <a  class="btn btn-danger" href="del_ser.php?id=<?php echo $row['id']; ?>"> Delete </a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                                </tbody>
