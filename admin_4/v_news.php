                    ...
                    <div class="portlet light portlet-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red sbold uppercase">View News</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="insert_news.php" class="btn green"> Add New
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['pashto_head'] ; ?></td>
                                    <td> <?php echo $row['pashto_body'] ; ?></td>
                                    <td>  <?php echo $row['pashto_footer'] ; ?> </td>
                                    <td class="center"> <img class="thumbnail" style="height: 100px; width: 100px;" src="../images/add-banners/add-books/<?php echo $row['pic'] ; ?>"></td>
                                    <td>
                                        <a class="btn btn-primary" href="edit_news.php?id=<?php echo $row['id']; ?>"> Edit </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger"  href="del_news.php?id=<?php echo $row['id']; ?>"> Delete </a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                                </tbody>
