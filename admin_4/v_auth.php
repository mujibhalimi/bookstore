                    ...
                    <div class="portlet light portlet-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red sbold uppercase">View authors</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="insert_auth.php" class="btn green"> Add New
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['p_author_name'] ; ?></td>
                                    <td> <?php echo $row['p_author_fname'] ; ?></td>
                                    <td>  <?php echo $row['p_bio'] ; ?> </td>
                                    <td><?php echo $row['phone'] ; ?></td>
                                    <td class="center"> <img class="thumbnail" style="height: 100px; width: 100px;" src="../images/aurthors/<?php echo $row['photo'] ; ?>"></td>
                                    <td>
                                        <a class="btn btn-primary" href="edit_auth.php?id=<?php echo $row['auth_id']; ?>"> Edit </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger"  href="del_auth.php?id=<?php echo $row['auth_id']; ?>"> Delete </a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                                </tbody>
