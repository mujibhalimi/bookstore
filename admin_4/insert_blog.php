...
if (isset($_POST['btn']))
{
    ...
    $query="INSERT INTO blog(user_id,heading,body,photo,headingp,pashto_body,approve,cate_id) VALUES ('$user_id','$name','$body','$filename1','$pname','$pbody','0','$cate')";
    $db->insert($query);
}
?>
<!DOCTYPE html>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="insert_blog.php" enctype="multipart/form-data" id="submit_form" method="POST">
