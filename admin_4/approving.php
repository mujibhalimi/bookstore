...
if (isset($_POST['btn']))
{
    ...
    $queryapprovupdate="update blog set approve='$approve' WHERE blog_id='$blog_id'";
    $run=$db->update($queryapprovupdate);
    header("location:approving.php?msg=approved");
}
?>
                    ...
                    <div class="portlet light portlet-fit bordered">
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                $query="SELECT * FROM blog,user,catagories WHERE catagories.cid=blog.cate_id AND user.id=blog.user_id";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="approving.php?id=<?php echo $blog_id=$row['blog_id']; ?>" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="approve" value="1">
                                        <button type="submit" name="btn" class="btn btn-primary"> approving </button>
                                        </form>
                                    </td>
                                    <td>
