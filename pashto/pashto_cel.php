            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="add-banner add-banner-1">
                    <div class="z-inedex-2 p-relative">
                        ...
                        <hr>
                        <strong class="font-merriweather"><?php echo $row['price']; ?> <sup>افغانۍ</sup></strong>
                    </div>
                    <img class="adds-book" class="adds-book" width="160px" height="168px" src="../images/add-banners/add-books/<?php echo $row['photo']; ?>" alt="">
                </div>
            </div>
            <!-- Banner -->
            <?php
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="add-banner add-banner-2">
                    <div class="z-inedex-2 p-relative">
                        ...
                        <hr>
                        <p><?php echo $row2['price']; ?><sup>افغانۍ</sup></p>
                    </div>
